...
//why are tilesets named backgrounds?
// they're a gms1 leftover
...
await Task.Run(() => Parallel.ForEach(Data.Backgrounds, (UndertaleBackground tileSet) => {
    ...
    TileSet tilesetData = new TileSet()
    {
        ...
        tilehsep = (int)tileSet.GMS2OutputBorderX * 2, //usually 4 in pt, but e.g tileset_tile_citydark has 0 separation
    ...
    string sprJson = @$"
        {{
          ...
          ""width"": {tileSet.Texture.SourceWidth},
          ""height"": {tileSet.Texture.SourceHeight},
          ""textureGroupId"": {{
            ""name"": ""Default"",
            ""path"": ""texturegroups/Default"",
          }},
